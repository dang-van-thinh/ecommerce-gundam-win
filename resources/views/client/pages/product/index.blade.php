                        ...
                        <div class="col-sm-2 col-3">
                            <div class="swiper product-slider product-slider-img">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"> <img src="/template/client/assets/images/product/slider/1.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide"> <img
                                            src="/template/client/assets/images/product/slider/2.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide"> <img
                                            src="/template/client/assets/images/product/slider/3.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide"> <img
                                            src="/template/client/assets/images/product/slider/4.jpg" alt=""><span>
                                            <i class="iconsax" data-icon="play"></i></span></div>
                                    <div class="swiper-slide"> <img
                                            src="/template/client/assets/images/product/slider/5.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide"> <img
                                            src="/template/client/assets/images/product/slider/6.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide"> <img
                                            src="/template/client/assets/images/product/slider/7.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="swiper product-slider-thumb product-slider-img-1">
                                <div class="swiper-wrapper ratio_square-2">
                                    <div class="swiper-slide"> <img class="bg-img"
                                            src="/template/client/assets/images/product/slider/1.jpg" alt=""></div>
                                    <div class="swiper-slide"> <img class="bg-img"
                                            src="/template/client/assets/images/product/slider/2.jpg" alt=""></div>
                                    <div class="swiper-slide"> <img class="bg-img"
                                            src="/template/client/assets/images/product/slider/3.jpg" alt=""></div>
                                    <div class="swiper-slide"> <video class="video-tag" loop="" autoplay=""
                                            muted="">
                                            <source src="/template/client/assets/images/product/slider/clothing.mp4"
                                                type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video></div>
                                    <div class="swiper-slide"> <img class="bg-img"
                                            src="/template/client/assets/images/product/slider/5.jpg" alt=""></div>
                                    <div class="swiper-slide"> <img class="bg-img"
                                            src="/template/client/assets/images/product/slider/6.jpg" alt=""></div>
                                    <div class="swiper-slide"> <img class="bg-img"
                                            src="/template/client/assets/images/product/slider/7.jpg" alt=""></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="product-box-3">
                            <div class="img-wrapper">
                                ...
                                <div class="product-image"><a class="pro-first" href="product.html"> <img class="bg-img"
                                            ...
                                            class="bg-img" src="/template/client/assets/images/product/product-3/9.jpg"
                                            alt="product"></a></div>
                        ...
                        <div class="product-box-3">
                            <div class="img-wrapper">
                                ...
                                <div class="product-image"><a class="pro-first" href="product.html"> <img class="bg-img"
                                            ...
                                            alt="product"></a><a class="pro-sec" href="product.html"> <img
                                            class="bg-img" src="/template/client/assets/images/product/product-3/22.jpg"
                                            alt="product"></a></div>
                                <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                            data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                        ...
                        <div class="product-box-3">
                            <div class="img-wrapper">
                                ...
                                <div class="product-image"><a class="pro-first" href="product.html"> <img class="bg-img"
                                            ...
                                            alt="product"></a><a class="pro-sec" href="product.html"> <img
                                            class="bg-img" src="/template/client/assets/images/product/product-3/10.jpg"
                                            alt="product"></a></div>
                                <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                            data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                        ...
                        <div class="product-box-3">
                            <div class="img-wrapper">
                                ...
                                <div class="product-image"><a class="pro-first" href="product.html"> <img class="bg-img"
                                            ...
                                            alt="product"></a><a class="pro-sec" href="product.html"> <img
                                            class="bg-img" src="/template/client/assets/images/product/product-3/20.jpg"
                                            alt="product"></a></div>
                                <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                            data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                        ...
                        <div class="product-box-3">
                            <div class="img-wrapper">
                                ...
                                <div class="product-image"><a class="pro-first" href="product.html"> <img class="bg-img"
                                            ...
                                            alt="product"></a><a class="pro-sec" href="product.html"> <img
                                            class="bg-img" src="/template/client/assets/images/product/product-3/12.jpg"
                                            alt="product"></a></div>
                                <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                            data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
