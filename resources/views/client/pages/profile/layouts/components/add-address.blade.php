        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <div class="from-group">
                            <label class="form-label">Email address</label><input class="form-control" type="email"
                                placeholder="john.smith@example.com" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="from-group">
                            <label class="form-label">Phone</label><input class="form-control" type="number"
                                name="review[author]" placeholder="Enter your Number." />
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="from-group">
