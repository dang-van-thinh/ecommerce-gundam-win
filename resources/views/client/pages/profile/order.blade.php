                                                        ...
                                                        <div class="order-box">
                                                            ...
                                                            <div class="product-order-detail">
                                                                ...
                                                                @php
                                                                    $day = \Carbon\Carbon::parse(
                                                                        $order->updated_at,
                                                                    )->gt(\Carbon\Carbon::now()->subDays(3));
                                                                ...
                                                                @if ($order->status === 'PENDING')
                                                                    <div class="position-relative">
                                                                        <div class="mt-3"
                                                                            ...
                                                                            <!-- Nút hủy đơn hàng -->
                                                                            <button
                                                                                style="background-color: #c28f51; border:none;"
                                                                                type="button" class="btn btn-danger"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#OrderModal">Hủy
                                                                                đơn hàng
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title"
                                                                                        id="CancelOrderModalLabel">Xác nhận
                                                                                        hủy đơn hàng
                                                                                    </h5>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <!-- Form nhập lý do hủy -->
                                                                                    <form
                                                                                        action="{{ route('profile.order.cancel', $order->id) }}"
                                                                                        method="POST" id="cancelOrderForm">
                                                                                        @csrf
                                                                                        @method('PUT')

                                                                                        <div class="form-group mt-3">
                                                                                            <label for="cancel_reason">Chọn
                                                                                                lý do hủy đơn
                                                                                                hàng:</label><br>
                                                                                            <input type="radio"
                                                                                                name="cancel_reason"
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                ...
                                                                                                id="payment_issue"
                                                                                                value="payment_issue">
                                                                                            <label for="payment_issue">Vấn
                                                                                                đề thanh toán</label><br>

                                                                                            <input type="radio"
                                                                                                name="cancel_reason"
                                                                                                id="long_wait_time"
                                                                                                value="long_wait_time">
                                                                                            <label for="long_wait_time">Chờ
                                                                                                lâu</label><br>
                                                            ...
                                                            @if ($order->confirm_status === 'IN_ACTIVE' && $order->status === 'PROCESSING')
                                                                <div class="mt-3 text-center">
                                                                    <button style="background-color: #c28f51; border:none;"
                                                                        type="button" class="btn btn-danger"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#CancelOrderModal">Xóa
                                                                        đơn hàng
                                                                    </button>
                                                                    <button style="background-color: #c28f51; border:none;"
                                                                        type="button" id="checkout-continue"
                                                                        data-order="{{ $order->id }}"
                                                                ...
                                                                <div class="modal fade" id="CancelOrderModal"
                                                                    tabindex="-1" aria-labelledby="CancelOrderModalLabel"
                                                                    aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="CancelOrderModalLabel">Xác nhận xóa
                                                                                    đơn hàng
                                                                                </h5>
                                                                                <button type="button" class="btn-close"
                                                                                    data-bs-dismiss="modal"
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <form
                                                                                    action="{{ route('profile.order.delete', $order->id) }}"
                                                                                    method="POST"
