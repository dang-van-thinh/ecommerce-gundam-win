                    ...
                    <ul class="nav-menu sm-horizontal theme-scrollbar" id="sm-horizontal">
                        ...
                        <li>
                            ...
                            <ul class="nav-submenu">
                                ...
                                <li> <a href="collection-right-sidebar.html">Collection Right Sidebar</a>
                                </li>
                        ...
                        <li> <a class="nav-link" href="#">Product <span> <i
                            ...
                            <div class="mega-menu overflow-hidden p-0">
                                <div class="row">
                                    <div class="col-xl-4">
                                        <ul class="p-2">
                                            ...
                                            <li> <a href="product-video.html">Product Video<span
                                                        class="badge-sm theme-default">new</span></a></li>
                                            <li> <a href="product-accordion.html">Product Accordion</a>
                                            </li>
                                            <li> <a href="product-sold-out.html">Product Sold Out <span
                                                        class="badge-sm danger-color animated">Hot</span></a>
                                            </li>
                                            <li> <a href="without-thumbnail.html">Without Thumbnail </a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-xl-4">
                                        <ul class="p-2">
                                            ...
                                            <li> <a href="variant-rectangle.html">Variant Rectangle </a>
                                            </li>
                                    ...
                                    <div class="col-xl-4 d-none d-xl-block px-0">
                                        <div class="menu-banner"> <img class="w-100 img-fluid"
                                                src="/template/client/assets/images/mega-menu/banner.png"
                                                alt="" /></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mega-menu overflow-hidden p-0">
                                <div class="row gy-4 align-items-center">
                                    ...
                                    <div class="col-xl-2 px-0">
                                        <ul>
                                            <li> <a href="../email-template/welcome.html">Welcome
                                                    Template<span class="badge-sm danger-color animated">Hot</span></a>
                                            </li>
                                    ...
                                    <div class="col-xl-5"><img class="img-fluid"
                                            src="/template/client/assets/images/mega-menu/1.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </li>
