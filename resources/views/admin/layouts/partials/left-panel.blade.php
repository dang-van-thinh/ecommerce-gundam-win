        ...
        <div id="main-menu" class="main-menu navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-list"></i><a href="{{route('categoryproduct.index')}}">Danh mục sản phẩm</a></li>
                        <li><i class="fa fa-list"></i><a href="{{route('categoryarticle.index')}}">Danh mục bài viết</a></li>
                    </ul>
                </li>
